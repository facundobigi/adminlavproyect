  ...
  Future<void> _showEdit({DocumentSnapshot<Map<String, dynamic>>? doc}) async {
    ...
    final ok = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        title: Text(doc == null ? 'Nuevo servicio' : 'Editar servicio'),
        content: Form(
          key: form,
          child: Column(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        iconTheme: const IconThemeData(color: kPrimary), // flecha azul
        ...
        child: ConstrainedBox(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                // Barra azul "Servicios" + botón Agregar
                Container(
                  height: 48,
                  ...
                  child: Container(
                    ...
                    child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                      ...
                      builder: (_, s) {
                        ...
                        if (docs.isEmpty) {
                          return const Center(child: Text('Sin servicios. Usa “Agregar servicio”.'));
                        }
          ...
          child: Row(
            children: [
              ...
              Padding(
                ...
                child: Text(precio, style: _priceStyle),
              ),
              // Acciones
